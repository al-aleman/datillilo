...
'''
# edited by Alberto Aleman (thanks to Camille Kessler) from Models_3D.py (Daniel Portik)
# edits are shown with #### ED #### blocks
# most edits were made for code re.usability and reproducibility
...
#**************
snps = "./SNPs_file_Northern_Central_Southern.txt"
...
pop_ids=['Northern','Central','Southern']
